...
namespace Dic.Xna.Framework.Utils
{
    public static class ObjUtil
    {
        ...
        public static bool EqualsAny(object obj, params object[] others)
        {
        ...
        public static MethodInfo FindMethod(Type tp, string name)
        {
            while (tp != null)
            {
                var meth = tp.GetMethod(name, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
                if (meth != null)
                {
                    return meth;
                }
